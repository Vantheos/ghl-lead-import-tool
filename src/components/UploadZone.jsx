  ...
  return (
    <div className="space-y-3">
      ...
      {selectedFilename && (
        <button
          onClick={handleReset}
          className="inline-flex items-center gap-2 text-sm font-medium text-[#3B8CCF] hover:text-white border border-[#3B8CCF]/40 hover:border-[#3B8CCF] bg-[#3B8CCF]/10 hover:bg-[#3B8CCF]/20 px-4 py-2 rounded-lg transition-all"
        >
