                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  ...
                  {unlocked && !isComplete && !isImporting && (
                    <button
                      ...
                      className="bg-[#047857] hover:bg-[#065F46] text-white font-semibold px-4 py-2 rounded-lg transition-colors text-sm"
                    >
                      Import
                    </button>
                  )}
                  {unlocked && isImporting && (
                    <button
                      disabled
                      className="bg-[#047857]/50 text-white/70 font-semibold px-4 py-2 rounded-lg text-sm cursor-not-allowed"
                    >
                      Importing…
                    </button>
                  )}
